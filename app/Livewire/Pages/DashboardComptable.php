...
class DashboardComptable extends Component
{
    public $codeFac;
    public $status;
    public $sexe;
    ...
    public function getlastTransactionsProperty()
    {
        $transactions = transactionPaiementModel::latest() // tri par date décroissante
            ->take(8)  // les 10 dernières
            ->get();
    ...
    {
        return view('livewire.pages.dashboard-comptable');
    }
}
