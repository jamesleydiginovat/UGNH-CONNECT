...
<section @class([
        ...
        <section @class([
            ...
            <div @class([
                ...
                <livewire:pages.course-byniveau-for-faculte />
            </div>
    ...
    'flex flex-col sm:flex-row gap-3 w-full'
            ...
            {{-- TABLEAU COURS DU JOUR --}}
            <div @class([
                'p-3 rounded bg-white shadow-xs w-full flex-1 overflow-x-auto no-scrollbar h-100',
                'dark:border-gray-600 dark:border dark:bg-gray-900'
            ])>

                <h1 @class([
                    'text-gray-600 px-3 font-bold flex flex-row gap-1 mb-3',
                    'dark:text-gray-200'
                ])>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor"
                        class="bg-ugnh-blueFonce p-1 rounded-full text-gray-50 w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <table class="w-full min-w-full">
                    ...
                    <thead @class(['border-b border-b-[#ccc]', 'dark:border-gray-600'])>
                        <tr>
                            <th @class([
                                'text-start font-normal text-gray-800  py-3 px-3 text-sm',
                                'dark:text-gray-200'
                            ])>
                                Cours
                            </th>
                    ...
                    <tbody>
                        @foreach ($this->CoursDuJours as $cours)
                            <tr @class([
                                'border-b border-b-[#ccc] hover:bg-ugnh-blueClair',
                                'dark:border-gray-600 dark:hover:bg-gray-800'
                            ])>

                                {{-- COURS --}}
                                <td @class([
                                    'font-normal py-2 px-3 text-sm text-gray-600',
                                    'dark:text-gray-300'
                                ])>
                                    <p>{{ $cours->cours }}</p>
            ...
            Acces Rapide
                ...
                <a @click="active='Etudiants'; localStorage.setItem('activeMenu','Etudiants')"  href="{{ $hasPermission ? Route('gestion-des-etudiants') : '#' }}">
                <div @class(['border-b border-[#ccc] hover:bg-ugnh-blueClair','dark:border-gray-600 dark:hover:bg-gray-800 transition-all easy-in-out duration-500'])>
                    <h1 @class(['text-start font-normal text-sm py-3 px-3 text-gray-600', 'dark:text-gray-300'])>Etudiants</h1>
                </div>
                </a>
                ...
                <a @click="active='Evaluations'; localStorage.setItem('activeMenu','Evaluations')" href="{{ $hasPermission ? Route('gestion-des-notes') : '#' }}">
                <div @class(['border-b border-[#ccc] hover:bg-ugnh-blueClair', 'dark:border-gray-600 dark:hover:bg-gray-800 transition-all easy-in-out duration-500'])>
                    <h1 @class(['text-start font-normal text-sm py-3 px-3 text-gray-600', 'dark:text-gray-300 dark:hover:bg-gray-800 transition-all easy-in-out duration-500'])>Notes</h1>
                </div>
                </a>
                ...
                <div @class(['border-b border-[#ccc] hover:bg-ugnh-blueClair', 'dark:border-gray-600 dark:hover:bg-gray-800 transition-all easy-in-out duration-500'])>
                    <h1 @class(['text-start font-normal text-sm py-3 px-3 text-gray-600', 'dark:text-gray-300 dark:hover:bg-gray-800 transition-all easy-in-out duration-500'])>Profile</h1>
                </div>
                </a>
