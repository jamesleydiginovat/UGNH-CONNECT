<section class="relative bg-white dark:bg-gray-900 m-3 min-h-full">
    <div class=" right-0 top-0 ">
        <div @class(['text-end  flex flex-row justify-between cursor-pointer p-1 text-red-500 mx-3'])
            ...
            >
                ...
                <svg @click="historiqueTransaction = !historiqueTransaction" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="sm:w-6 w-3 sm:h-6 h-3 transition-all duration-500 ease-in-out hover:bg-red-500 hover:text-gray-300 rounded-sm">
    ...
    <section class="dark:text-gray-50 m-3">
        ...
        <div>
            ...
            <div class="flex flex-row mb-3 items-center relative">
                <input wire:model.live="rechercherTransaction" class="border pe-10 border-ugnh-blueClair shadow-sm rounded-lg p-2 w-full outline-none" type="text" name="" id="" placeholder="Rechercher par code transaction" >
