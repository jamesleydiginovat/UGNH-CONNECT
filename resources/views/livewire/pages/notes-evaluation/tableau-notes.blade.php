		...
		<table class="min-w-full text-xs ">
            ...
            @foreach ($this->LesNotes as $matricule => $etudiantNotes)
                ...
                <tr class="border-b border-[#ccc] dark:border-gray-600 hover:bg-ugnh-blueClair transition-all duration-200 ease-in-out  dark:hover:bg-gray-800">
                    ...
                    <td class="p-1 ">
                        <svg wire:click="sessionNoteByEtudiant('{{ $matricule }}', '{{ $etudiant->niveau }}','{{ $etudiant->faculte->codeFac ?? '---'}}')"  @click="tableSlideNoteByStudent = !tableSlideNoteByStudent"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-full h-6 cursor-pointer text-center ">
