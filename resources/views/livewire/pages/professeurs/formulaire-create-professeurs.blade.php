...
>
    ...
    <div class="absolute z-10  w-full m-auto h-full flex flex-row  items-center justify-center">
        ...
        <div class="relative bg-white dark:bg-gray-800 dark:border-5 dark:border-gray-600 lg:w-[60%]  sm:w-[80%] w-full sm:h-auto h-full rounded-lg shadow-2xl overflow-y-auto ">
            ...
            "
            x-show="show"
            class="flex w-full overflow-hidden bg-white shadow-md absolute top-0 left-0 z-10"
            >
            ...
            <div class="px-4 py-2 -mx-3">
               ...
               {{-- message d'info --}}
                ...
                "
                x-show="show"
                class="flex w-full overflow-hidden bg-white  dark:bg-gray-700 shadow-md absolute z-10 top-0 left-0"
                >
                ...
                <div class="px-4 py-2 -mx-3">
                    <div class="mx-3">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-50" x-text="message"></p>
                    </div>
                </div>
            ...
            <div   wire:click="makeIdNull"@class(['fixed sm:absolute sm:top-0  z-50 sm:top-0 top-1 right-1 sm:right-0 bg-red-500 sm:bg-transparent  cursor-pointer  p-1 sm:text-red-500 text-gray-50 transition-all duration-500 ease-in-out hover:bg-red-500 hover:text-gray-300'])
            @click="form = !form"
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="sm:w-6 w-3 sm:h-6 h-3 transition-all duration-100 ease-in-out">
                <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
           ...
           <form wire:submit="save" 
            ...
            <div 
                ...
                class="sm:w-34 w-20 sm:h-34 h-20 rounded-3xl bg-ugnh-blueFonce  z-30 absolute sm:top-10 top-7 sm:right-10 right-1 sm:left-auto  border-4 border-ugnh-blueClair dark:border-ugnh-blueClair cursor-pointer"
            ...
            >
                ...
                @else
                    src="{{ Storage::url("photosProfesseurs/".$photoAfficher)}}"
                @endif 
                ...
                alt="Ajouter la photo du professeur"
                >
            ...
            <div @class(['flex sm:flex-row flex-col gap-5 '])>
                ...
                <label class="font-bold text-gray-500"  for="codeProf">Code:</label>
                <input wire:model="codeProf" @readonly(true) @class(['outline-0 w-full mx-3']) type="text" id="codeProf" >
                </div>
            </div>
            </div>
            ...
            <h1 class="font-bold text-xl">Renseignements personnels <span class="text-xs font-normal italic"></span></h1>
            ...
            <div @class(['flex sm:flex-row flex-col gap-5 '])>
                ...
                <input wire:model="nom" @class(['outline-0 border-b border-gray-600 w-full mx-3', 'border-red-600'=>$errors->has('nom')]) type="text" id="nom" >
                ...
                <input wire:model="prenom" @class(['outline-0 border-b border-gray-600 w-full mx-3', 'border-red-600'=>$errors->has('prenom')]) type="text" id="prenom" >
            ...
            <div @class(['flex sm:flex-row flex-col gap-5 '])>
                ...
                <input wire:model="adresse" @class(['outline-0 border-b border-gray-600 w-full mx-3', 'border-red-600'=>$errors->has('adresse')]) type="text" id="adresse" >
            ...
            <div class="w-full flex flex-row">
                <label class="font-bold text-gray-500"  for="specialite">Specialite:</label>
                <div class="relative w-[75%]  pb-4">
                <input wire:model="specialite" @class(['outline-0 border-b border-gray-600 w-full mx-3', 'border-red-600'=>$errors->has('specialite')]) type="text" id="specialite" >
                @error('specialite') <p class="text-red-500 text-[10px] absolute  mx-3 bottom-0">{{ $message }}</p> @enderror
                </div>
            </div>
            ...
            <div @class(['flex  flex-col gap-5 '])>
                ...
                <div class=" flex flex-row">
                    ...
                    <select wire:model="conditionMatrimoniale" @class([
                    'outline-0 border-b border-gray-600 mx-3 w-full',
                    'border-red-600'=>$errors->has('conditionMatrimoniale'),
                    'dark:text-ugnh-blueClair dark:border-gray-600'
                    ]) name="" id="conditionMatrimoniale">
                        <option class="dark:text-ugnh-blueFonce" value=""></option>
                ...
                <div class="relative w-[70%]  pb-4">
                <input wire:model="email" @class(['outline-0 border-b border-gray-600 mx-3 sm:w-[80%] w-full','border-red-600'=>$errors->has('email')]) type="email" id="email" >
