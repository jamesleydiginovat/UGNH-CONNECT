<section class="dark:text-gray-50">
                    ...
                    <div class="flex flex-row gap-3">
                        ...
                        <div @class([
                            ...
                            'dark:text-ugnh-blueClair dark:border-gray-600'
                                ...
                                <option class="dark:text-gray-200 dark:bg-gray-600" value="Supprimer">Supprime</option>
            ...
            <section class="flex flex-col gap-2 w-full">
                ...
                <div class="page  bg-white text-black mx-auto">
                    ...
                    <section style="margin-top: 20px;">
                        ...
                        @if ($this->codePersonnel =="")
                            
                                @if ($this->ListePersonnel->isEmpty())
                                    <p>Aucun!</p>
                                @else
                                    <table x-show="!fullInformation" style="border: solid 1px; " width="100%" cellspacing="0" cellpadding="5">
                                        ...
                                        <tbody>
                                            @foreach ($this->ListePersonnel as $personnel )
                                            <tr style="border: solid 1px;">
                                                
                                                <td style="border: solid 1px; padding: 3px;">{{ $personnel->code }}</td>
    ...
    class="h-full"
     ...
     <section class="mx-3 h-screen">
        ...
        <livewire:pages.pdf.iframes.pdf-personnels />
    </section>
