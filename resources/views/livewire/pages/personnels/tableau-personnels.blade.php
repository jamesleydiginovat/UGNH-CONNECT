<div class="mx-3 text-gray-700  dark:text-gray-300 p-3 bg-white dark:bg-gray-900 rounded-t-lg dark:border dark:border-gray-700 ">
    ...
    <div @class([
		...
		@class([
            ...
            <input wire:model.live="search" :class="!inpuRecherche ? 'w-full p-1 pe-8  md:w-0 lg:w-full md:p-0 md:pe-0 lg:p-1 lg:pe-8' : 'w-full p-1 pe-8'" class=" bg-blue-50 dark:bg-gray-600 shadow-sm rounded  outline-0  dark:text-gray-300 dark:border-gray-600 " type="search" name="" id="" placeholder="Nom / prenom / code">
			...
			@foreach ($this->Personnels as $personnel)
				<tr class="border-b border-[#ccc] dark:border-gray-800 dark:hover:bg-gray-600 hover:bg-ugnh-blueClair  transition-all duration-200 ease-in-out ">
                    ...
                    <td class="p-1 flex flex-row justify-center">
                        <svg  wire:click="sessionEdit({{ $personnel->id }})" @click="form = !form, $dispatch('open-modal')" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 cursor-pointer hover:scale-120">
