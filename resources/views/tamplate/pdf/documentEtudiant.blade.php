                ...
                @else
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="th" >{{ $etudiant->matricule }}</td>
                                <td class="th" >{{ $etudiant->nom . " " . $etudiant->prenom }}</td>
                                <td class="th" >{{ $etudiant->email }}</td>
                                <td class="th" >{{ $etudiant->telephone }}</td>
                                <td class="th" >{{ $etudiant->adresse }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <table width="100%" cellspacing="0" cellpadding="5">
                    <tbody>
                        ...
                        <tr class="bg-blue-100" style="background-color: #bcdef7">
                            ...
                            <td class="text-end" style="padding: 3px; text-align: end; font-weight: bold;">{{ $etudiant->status }}</td>
                        </tr>
