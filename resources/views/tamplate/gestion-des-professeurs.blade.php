...
<div @class([
    ...
    'lg:flex-row',
    'dark:border-gray-600 dark:bg-gray-900 dark:border'
])>
        <div @class([
            ...
            'sm:flex-row  '
                ...
                <livewire:pages.professeurs.counter-professeur />
                ...
                @class([
                    'p-3 rounded w-full flex flex-row items-center justify-center bg-ugnh-blueFonce',
                    'dark:border-gray-600 dark:bg-gray-700'
                ])>
                 <p @class([
                    'font-bold text-gray-200 text-xl text-center',
                    'dark:text-gray-300 '
                    ])>
                    Afficher les horaires</p>
    ...
    <div @class([
        ...
        'lg:justify-end lg:ps-5 lg:pt-0 '
    ])>
        ...
        <button
            ...
            @class([
                ...
                // ACTIF ADMIN
                'bg-ugnh-blueFonce text-gray-50 hover:bg-ugnh-blueHover hover:shadow-lg' => $isAdmin,
...
<livewire:pages.professeurs.formulaire-create-professeurs />
...
<div 
    ...
    <livewire:pages.professeurs.tableau-professeurs />
...
<div 
    ...
    <livewire:pages.pdf.documents-professeurs />
